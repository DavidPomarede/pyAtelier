...
#    if turtle.xcor() >= 0 :
    ...
    for side in range(5000):
        ...
        x = range(10)
        for n in x:
            turtle.pencolor(random.randrange(random.randrange(1, 150), random.randrange(150, 170)), random.randrange(random.randrange(100, 150), random.randrange(150, 160)), random.randrange(random.randrange(1, 150), random.randrange(150, 255)))
            size_pen = abs(turtle.ycor() + turtle.xcor())/2
            turtle.pen(pensize=size_pen)
            print(size_pen)
            turtle.right(10)
